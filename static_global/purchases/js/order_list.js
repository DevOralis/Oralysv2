...
function searchOrders() {
    ...
    if (!searchTerm) {
        // Si pas de recherche, réinitialiser les commandes filtrées
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const tableBody = document.getElementById("order-table-body");
    const orderListFilteredUrl = document.querySelector('.main').dataset.orderListFilteredUrl;
            ...
            fetch(`/purchases/orders/detail-json/${orderId}/`, {
                ...
                .then(data => {
                    ...
                    let html = `
                        ...
                        <p><strong>Fournisseur:</strong> ${data.supplier.name || 'N/A'}</p>
